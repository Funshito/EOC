          ...
          <div className="w-full">
            <div>
              ...
              <ul className="w-full capitalize text-sm font-medium leading-13">
                <a href="" >
                  <li className="hover:text-blue-900 hover:bg-white px-6 hover:font-bold">Staffs</li>
                </a>
                <a href="">
                  <li className="hover:text-blue-900 hover:bg-white px-6 hover:font-bold">documents</li>
                </a>
                <a href="">
                  <li className="hover:text-blue-900 hover:bg-white px-6 hover:font-bold">Employement</li>
                </a>
                <a href="">
